...
// export const loadRoutesCatchAll = async function (app: Express) {
//   // app.get(/^[^.]*$/, async function (req, res, next) {
//   app.get("*", async function (req, res, next) {
